<?php 
	$query = "SELECT * from revenus10";
	$exec = mysqli_query($con,$query);
	while($row = mysqli_fetch_array($exec)){
	echo "['".$row['year']."',".$row['revenus_en_millions']."],";
	 }
?>
...
<head>
 ...
 var options = {
 title: 'Revenus par an générés par l\'ufc par an en millions de dollars',
  pieHole: 0.5,
          pieSliceTextStyle: {
            color: 'black',
          },
